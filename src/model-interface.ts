 ...
 *
 * Includes essentials for training and weight management.
 * For models that support generation/sampling, see Generative interface.
 */
...
/**
 * Interface for models that support sample generation
 */
